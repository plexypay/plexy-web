...
const PixQRDetails = () => {
    ...
    return (
        <div className="plexy-checkout__qr-loader--pix__qr_details">
            <QRImage src={qrCodeImage} onLoad={onQRCodeLoad} />
            <div className="plexy-checkout__qr-loader--pix__qr_details__timer">
            ...
            <Field name="pix-code" useLabelElement={false}>
                <InputText
                    className="plexy-checkout__qr-loader--pix__qr_details__code"
                    value={qrCodeData}
                    readonly
