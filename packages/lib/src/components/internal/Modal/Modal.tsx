...
const Modal = ({
    ...
    return (
        ...
        <div
            className={cx(
                'plexy-checkout__modal-wrapper',
                classNameModifiers.map(m => `plexy-checkout__modal-wrapper--${m}`),
                { 'plexy-checkout__modal-wrapper--open': isOpen }
            )}
            role="dialog"
            ...
            {...props}
        >
            <div className="plexy-checkout__modal" ref={modalContainerRef}>
