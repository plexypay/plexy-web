...
export default function CVCHint({ frontCVC = false, fieldLabel, onClick }: CVCHintProps) {
    const hintClassnames = classNames({
        'plexy-checkout__card__cvc__hint__wrapper': true,
        'plexy-checkout__field__cvc--front-hint': !!frontCVC,
        'plexy-checkout__field__cvc--back-hint': !frontCVC
    });
    ...
    return (
        ...
        <span className={hintClassnames} onClick={onClick}>
            <svg
                className={'plexy-checkout__card__cvc__hint plexy-checkout__card__cvc__hint--front'}
                width="27"
                height="18"
                viewBox="0 0 27 18"
                fill="none"
                ...
                role={'img'}
            >
                <title id={'plexy-checkout__cvc__front-hint-img'}>{fieldLabel}</title>
                <path
                ...
                <rect className={'plexy-checkout__card__cvc__hint__location'} x="16.5" y="4.5" width="7" height="5" rx="2.5" stroke="#C12424" />
            </svg>

            <svg
                className={'plexy-checkout__card__cvc__hint plexy-checkout__card__cvc__hint--back'}
                width="27"
                height="18"
                viewBox="0 0 27 18"
                fill="none"
                ...
                role={'img'}
            >
                <title id={'plexy-checkout__cvc__back-hint-img'}>{fieldLabel}</title>
                <path
                ...
                <path
                    ...
                    fill="white"
                />
                <rect className={'plexy-checkout__card__cvc__hint__location'} x="16.5" y="9.5" width="7" height="5" rx="2.5" stroke="#C12424" />
            </svg>
        </span>
    );
}
