...
export const MerchantPage: PixBiometricStory = {
    ...
    args: {
        useSessions: false,
        countryCode: 'BR',
        componentConfiguration: { _isPlexyHosted: false }
    },
    parameters: {
        msw: useMsw
            ? {
    ...
    parameters: {
        msw: useMsw
            ? {
                  handlers: [
                      http.post(
                          'https://checkoutshopper-test.plexy.com/checkoutshopper/utility/v1/pixpaybybank/redirect-result?clientKey=test_L6HTEOAXQBCZJHKNU4NLN6EI7IE6VRRW',
                          () => {
                      ...
                      http.get(
                          'https://checkoutshopper-test.plexy.com/checkoutshopper/utility/v1/pixpaybybank/registration-options/enrollment123?clientKey=test_L6HTEOAXQBCZJHKNU4NLN6EI7IE6VRRW',
                          () => {
                              return HttpResponse.json(
    ...
    parameters: {
        msw: {
            handlers: [
                ...
                http.get(
                    'https://checkoutshopper-test.plexy.com/checkoutshopper/utility/v1/pixpaybybank/authorization-options?initiationId=initiation123&enrollmentId=enrollment123&clientKey=test_L6HTEOAXQBCZJHKNU4NLN6EI7IE6VRRW',
                    () => {
                        return HttpResponse.json(
