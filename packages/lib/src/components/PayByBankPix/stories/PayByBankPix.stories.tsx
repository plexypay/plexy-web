    ...
    parameters: {
        msw: useMsw
            ? {
                  handlers: [
                      http.post(
                          'https://api.plexypay.com/v2/checkoutshopper/utility/v1/pixpaybybank/redirect-result?clientKey=test_L6HTEOAXQBCZJHKNU4NLN6EI7IE6VRRW',
                          () => {
                      ...
                      http.get(
                          'https://api.plexypay.com/v2/checkoutshopper/utility/v1/pixpaybybank/registration-options/enrollment123?clientKey=test_L6HTEOAXQBCZJHKNU4NLN6EI7IE6VRRW',
                          () => {
                              return HttpResponse.json(
    ...
    parameters: {
        msw: {
            handlers: [
                ...
                http.get(
                    'https://api.plexypay.com/v2/checkoutshopper/utility/v1/pixpaybybank/authorization-options?initiationId=initiation123&enrollmentId=enrollment123&clientKey=test_L6HTEOAXQBCZJHKNU4NLN6EI7IE6VRRW',
                    () => {
                        return HttpResponse.json(
