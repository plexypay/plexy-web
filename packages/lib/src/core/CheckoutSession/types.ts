...
import { BoltConfiguration, FastCheckoutProfile, SkipifyConfiguration } from '../../components/internal/FastCheckout/types';
...
export type CheckoutSessionShopperDetailsResponse = {
    sessionData: string;
} & FastCheckoutProfile;
